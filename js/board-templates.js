function createTodo(element, i) {
    return  /*html*/ `
        <div draggable="true" ondragstart="startDragging(${element['id']})" onclick="openTask(${element['id']})" class="task" id="task${element['id']}">
    ...
    return /*html*/ `
        <div style="background-color: ${name['color']};" class="contact">
            <div style="display: flex;">
                <p class="letter-p" style="margin-right: 1px;">${name['first-name'].charAt()}</p>
    ...
    return /*html*/ `
        <div onclick="event.stopPropagation()" class="opened-task" id="opened-task${idToOpen}">
            ...
            <div class="inner-div">
                ...
                <p class="opened-task-title">${tasks[idToOpen]['title']}</p>
                ...
                <div class="edit-cancel">
                    <div onclick="editTask(${idToOpen}, ${id})" class="background-div">
                        <img src="img/pencil.png">
                    </div>  
                    <div onclick="deleteTask(${idToOpen})" class="background-div">
...
function createNamesOnOpenedTask(name) {
    return /*html*/ `
        <div class="new-name-opened-card">
            <p style="background-color: ${name['color']};" class="name-letters">${name['first-name'].charAt(0).toUpperCase()}${name['last-name'].charAt(0).toUpperCase()}</p>
...
function createEditableTask(idToOpen, id) {
    return /*html*/ `
        <div class="inner-div">
                <div class="edit-task-xmark">
                    <img onclick="closeTask()" src="img/x-mark2.png">
                </div>
                ...
                <div style="margin-bottom: 10px;" class="div-description">
                    ...
                    <textarea required id="input-description-edit-task" class="add-task-placeholder-edit-task" placeholder="Enter a Description"></textarea>
                </div>
                <div class="div-date-edit-task">
                    ...
                    <div>
                        ...
                        <div id="drop-down-box" class="drop-down-box-edit-task">
                            <div onclick="showContacts()" class="input-div-new" style="height: 29px;">
                ...
                <div class="edit-cancel">
                    <div onclick="saveEditedTask(${id}, ${idToOpen})" class="background-div-edit-task" id="ok-button">
...
function createAddTaskWindow(year, month, day) {
    return /*html*/ `
        <div onclick="event.stopPropagation()" class="add-task-window" id="add-task-window">
            <form class="form-add-task-window" onsubmit="addNewTask('Board'); return false;">
            <img class="x-mark-add-task" onclick="closeAddTask()" src="img/x-mark2.png">    
            <div class="add-task-headline-div">
                <p class="add-task-headline">Add Task</p>
                
            </div>
            <div class="add-task-inner-div">
                <div class="left-container">
                    <div class="div-title">
                        <p class="add-task-p">Title</p>
                        <input
                    ...
                    <div class="div-description">
                        <p class="add-task-p">Description</p>
                        <textarea
                        oninvalid="this.setCustomValidity('This field is required')"
                        oninput="setCustomValidity('')"
                        required id="input-description" class="add-task-placeholder" placeholder="Enter a Description"></textarea>
                    </div>
                ...
                <div class="right-container" onclick="closeInputs()">
                    <div class="div-date">
    ...
    return /*html*/ `
        <div class="new-div-category-input">
            ...
            <div class="container-icons-subtask div-new-cat" id="container-icons">
                ...
                <img onclick="saveNewCategory()" class="hook" id="hook-category" src="img/hook.png">
            </div>
        </div>
    `;
}
...
function createWorkspaceCategorys(idToOpen) {
    return /*html*/ `
        <div class="category-hook">
            <p onclick="changeWorkspace(${idToOpen}, 'To do')" class="choose-category-p move-div-p">To Do</p>
            <img id="category-hook1" src="img/hook.png">
        </div>
        <div class="category-hook">
            <p onclick="changeWorkspace(${idToOpen}, 'In Progress')" class="choose-category-p move-div-p">In progress</p>
            <img id="category-hook2" src="img/hook.png">
        </div>
        <div class="category-hook">
            <p onclick="changeWorkspace(${idToOpen}, 'Awaiting Feedback')" class="choose-category-p move-div-p">Awaiting feedback</p>
            <img id="category-hook3" src="img/hook.png">
        </div>
        <div class="category-hook">
            <p onclick="changeWorkspace(${idToOpen}, 'Done')" class="choose-category-p move-div-p">Done</p>
